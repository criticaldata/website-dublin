			...
			<div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
				...
				<div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
					{partners.map((partner) => (
						<div
							key={partner.name}
							className="group relative flex flex-col items-center justify-center gap-3 rounded-2xl bg-white px-6 py-10 min-h-[150px] sm:min-h-[190px] ring-1 ring-white/20 hover:ring-teal-400/50 hover:-translate-y-1 hover:shadow-2xl hover:shadow-teal-900/30 transition-all duration-300"
						>
							<Image
								src={partner.logo}
								alt={partner.name}
