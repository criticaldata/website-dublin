(() => {
  ...
  if (sectionHeadings.length) {
    ...
    const buildLines = ({ heading, label }) => {
      ...
      measureNode.className = "section-heading-measure";
      ...
      heading.replaceChildren(measureNode);

      const wordNodes = Array.from(measureNode.querySelectorAll(".section-heading-word"));
      const lineGroups = [];
      let currentLine = [];
      let lastTop = null;
